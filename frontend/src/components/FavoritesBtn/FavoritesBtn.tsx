...
export const FavoritesBtn: FC<FavoritesBtnProps> = ({
  ...
  useEffect(() => {
    document.body.style.overflow = showFavorite ? "hidden" : "auto";
  }, [showFavorite]);
	return (
		<button
			type="button"
		...
		>
			...
			<svg
				...
				width={50}
				height={50}
				className="mx-auto rounded-lg bg-blue duration-150 hover:bg-purple hover:fill-red-400"
				fill={`${showFavorite ? "#F2BC8D" : "#F29F8D"}`}
